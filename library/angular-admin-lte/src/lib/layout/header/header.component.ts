...
export class HeaderComponent implements AfterViewInit, OnDestroy {
  ...
  @ContentChild(HeaderLogoComponent, { read: true, static: false }) public headerLogoComponent: HeaderLogoComponent;
  @ContentChild(HeaderLogoMiniComponent, { read: true, static: false }) public headerLogoMiniComponent: HeaderLogoMiniComponent;

  @ViewChild('headerElement', { read: true, static: false }) private headerElement: ElementRef;
  @ViewChild('sidebarLeftToggleElement', { read: true, static: false }) private sidebarLeftToggleElement: ElementRef;
  @ViewChild('sidebarRightToggleElement', { read: true, static: false }) private sidebarRightToggleElement: ElementRef;
